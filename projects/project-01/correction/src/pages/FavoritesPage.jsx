  ...
  if (!favorites.length) return (
    <div className="container">
      ...
      <div style={{ textAlign: "center", padding: "3rem", color: "var(--text-secondary)" }}>
        ...
        <Link to="/" className="view-btn" style={{ display: "inline-block", marginTop: "1rem", width: "auto", padding: "0.75rem 2rem" }}>Browse Cars</Link>
      </div>
    </div>
  );
        ...
        {favorites.map((car) => (
          <div key={car.id} className="car-card">
            <div className="card-header">
              ...
              <button className="favorite-btn favorite-active" onClick={() => dispatch(toggleFavorite(car))}>
